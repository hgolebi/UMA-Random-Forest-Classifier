...
if __name__ == "__main__":
    ...
    run_all(mushrooms_dataset, ('e', 'p'), 5, True, True)
    run_all(heart_dataset, ('0', '1'), 5, True, True)

    # checking an impact on results of different dataset division size (training/test set)
    dataset20to80 = Dataset("heart.csv", 0.1)
    run_all(dataset20to80, ('0', '1'), 5, False, True)
    dataset20to80 = Dataset("heart.csv", 0.2)
    run_all(dataset20to80, ('0', '1'), 5, False, True)
    dataset30to70 = Dataset("heart.csv", 0.3)
    run_all(dataset30to70, ('0', '1'), 5, False, True)
    dataset40to60 = Dataset("heart.csv", 0.4)
    run_all(dataset40to60, ('0', '1'), 5, False, True)
    dataset50to50 = Dataset("heart.csv", 0.5)
    run_all(dataset50to50, ('0', '1'), 5, False, True)
    dataset50to50 = Dataset("heart.csv", 0.6)
    run_all(dataset50to50, ('0', '1'), 5, False, True)
